...
pubDate: 2026-04-01T16:56:47+02:00
...
tags: [linux, yubico, authentication, fido2, authentik, webauth, mfa, homelab]
categories: [Linux, Security]
description: "This guide covers the implementation of hardware-backed authentication by integrating Yubico..."
---

import yubicoImg from '../../../assets/images/2026/integrating_yubikey_fido2_with_authentik/yubico.png';
import webauthImg from '../../../assets/images/2026/integrating_yubikey_fido2_with_authentik/webauth.png';
import defaultAuthenticationFlowImg from '../../../assets/images/2026/integrating_yubikey_fido2_with_authentik/default-authentication-flow.png';
import devicesSlassesImg from '../../../assets/images/2026/integrating_yubikey_fido2_with_authentik/devices_slasses.png';
import configuredActionImg from '../../../assets/images/2026/integrating_yubikey_fido2_with_authentik/configured_action.png';
import configurationStagesImg from '../../../assets/images/2026/integrating_yubikey_fido2_with_authentik/configuration_stages.png';
import userVerificationImg from '../../../assets/images/2026/integrating_yubikey_fido2_with_authentik/user_verification.png';
import loginImg from '../../../assets/images/2026/integrating_yubikey_fido2_with_authentik/login.png';
...
<div style="width: 30%; margin: 10px auto; text-align: center;">
    <Image src={yubicoImg} alt="Yubico" widths={[640, 960, 1280, 1600]} sizes="(max-width: 768px) 100vw, 900px" formats={['avif', 'webp']} quality={80} loading="lazy" />
</div>
...
<div style="width: 100%; margin: 10px auto; text-align: center;">
    <Image src={webauthImg} alt="Enrolling Your Device" widths={[640, 960, 1280, 1600]} sizes="(max-width: 768px) 100vw, 900px" formats={['avif', 'webp']} quality={80} loading="lazy" />
</div>
...
<div style="width: 100%; margin: 10px auto; text-align: center;">
    <Image src={defaultAuthenticationFlowImg} alt="Configuring the Authentication Flow" widths={[640, 960, 1280, 1600]} sizes="(max-width: 768px) 100vw, 900px" formats={['avif', 'webp']} quality={80} loading="lazy" />
</div>
...
<div style="width: 100%; margin: 10px auto; text-align: center;">
    <Image src={devicesSlassesImg} alt="Devices slasses" widths={[640, 960, 1280, 1600]} sizes="(max-width: 768px) 100vw, 900px" formats={['avif', 'webp']} quality={80} loading="lazy" />
</div>

6. Not configured action: `Force the user to configure an authenticator`.

<div style="width: 100%; margin: 10px auto; text-align: center;">
    <Image src={configuredActionImg} alt="Configured action" widths={[640, 960, 1280, 1600]} sizes="(max-width: 768px) 100vw, 900px" formats={['avif', 'webp']} quality={80} loading="lazy" />
</div>
...
<div style="width: 100%; margin: 10px auto; text-align: center;">
    <Image src={configurationStagesImg} alt="Configuration stages" widths={[640, 960, 1280, 1600]} sizes="(max-width: 768px) 100vw, 900px" formats={['avif', 'webp']} quality={80} loading="lazy" />
</div>

8. WebAuthn User verification: Select `User verification must occur`.

<div style="width: 100%; margin: 10px auto; text-align: center;">
    <Image src={userVerificationImg} alt="WebAuthn User verification" widths={[640, 960, 1280, 1600]} sizes="(max-width: 768px) 100vw, 900px" formats={['avif', 'webp']} quality={80} loading="lazy" />
</div>

### Step 3: Testing the Login Flow

<div style="width: 100%; margin: 10px auto; text-align: center;">
    <Image src={loginImg} alt="Testing the Login Flow" widths={[640, 960, 1280, 1600]} sizes="(max-width: 768px) 100vw, 900px" formats={['avif', 'webp']} quality={80} loading="lazy" />
</div>
