...
tags: [linux, yubico, authentication, fido2, authentik, webauthn, mfa, homelab]
...
<div style="width: 30%; margin: 10px auto; text-align: center;">
    <Image src={yubicoImg} alt="Yubico" />
</div>
...
<div style="width: 100%; margin: 10px auto; text-align: center;">
    <Image src={webauthImg} alt="Enrolling Your Device" />
</div>
...
<div style="width: 100%; margin: 10px auto; text-align: center;">
    <Image src={defaultAuthenticationFlowImg} alt="Configuring the Authentication Flow" />
</div>
...
<div style="width: 100%; margin: 10px auto; text-align: center;">
    <Image src={devicesSlassesImg} alt="Devices slasses" />
</div>

6. Not configured action: `Force the user to configure an authenticator`.

<div style="width: 100%; margin: 10px auto; text-align: center;">
    <Image src={configuredActionImg} alt="Configured action" />
</div>
...
<div style="width: 100%; margin: 10px auto; text-align: center;">
    <Image src={configurationStagesImg} alt="Configuration stages" />
</div>

8. WebAuthn User verification: Select `User verification must occur`.

<div style="width: 100%; margin: 10px auto; text-align: center;">
    <Image src={userVerificationImg} alt="WebAuthn User verification" />
</div>

### Step 3: Testing the Login Flow

<div style="width: 100%; margin: 10px auto; text-align: center;">
    <Image src={loginImg} alt="Testing the Login Flow" />
</div>
