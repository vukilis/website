...
<Image src={containersImg} alt="Containers" />
...
<Image src={categoriesImg} alt="Categories" />
...
<Image src={searchImg} alt="Search Application" />
...
<Image src={appModalImg} alt="App Modal" />
...
<Image src={recentlyImg} alt="Recently Activity" />
