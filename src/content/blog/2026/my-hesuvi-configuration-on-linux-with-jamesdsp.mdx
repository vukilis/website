...
tags: [arch, audio, hesuvi, pipewire, surround, tool]
categories: [Linux]
...
<Image src={jamesdspPlaybackImg} alt="JamesDSP Playback" widths={[640, 960, 1280, 1600]} sizes="(max-width: 768px) 100vw, 900px" formats={['avif', 'webp']} quality={80} loading="lazy" />

<Image src={jamesdspOutputImg} alt="JamesDSP Output Devices" widths={[640, 960, 1280, 1600]} sizes="(max-width: 768px) 100vw, 900px" formats={['avif', 'webp']} quality={80} loading="lazy" />
...
<Image src={helvumImg} alt="Helvum" widths={[640, 960, 1280, 1600]} sizes="(max-width: 768px) 100vw, 900px" formats={['avif', 'webp']} quality={80} loading="lazy" />
