...
tags: [linux, debian, proxmox, pve, optimization, homelab]
categories: [Linux]
...
<div style="width: 100%; margin: 10px auto; text-align: center;">
    <Image src={diagramImg} alt="Hierarchy of system interactions" widths={[640, 960, 1280, 1600]} sizes="(max-width: 768px) 100vw, 900px" formats={['avif', 'webp']} quality={80} loading="lazy" />
</div>
