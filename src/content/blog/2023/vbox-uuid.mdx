...
pubDate: 2023-06-21T01:48:51+02:00
...
Changing the UUID for a copied VirtualBox VM eliminates the conflict that prevents the new VM from starting, allowing you to run multiple independent instances.
