...
<Image src={fontSettingsImg} alt="Font" widths={[640, 960, 1280, 1600]} sizes="(max-width: 768px) 100vw, 900px" formats={['avif', 'webp']} quality={80} loading="lazy" />
...
- Steps:  
    ...
    - Now we need to active our customised powershell profile with next command:
        ...
        <Image src={terminalImg} alt="Terminal" widths={[640, 960, 1280, 1600]} sizes="(max-width: 768px) 100vw, 900px" formats={['avif', 'webp']} quality={80} loading="lazy" />
